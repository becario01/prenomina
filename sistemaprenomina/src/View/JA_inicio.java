...
//                        tabla1.addRow(datos);
      ...
      private void initComponents() {
            ...
            lblcargojefe = new javax.swing.JLabel();
            ...
            lblnombrejefe.setEnabled(false);
    ...
    private void pmiRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pmiRegistrarActionPerformed
          ...
          if (cuentaFilasSeleccionadas == 1) {
                ...
                String Semana = cmbSemana.getSelectedItem().toString();
                inc.setVisible(true);
                inc.mostrardatos(empid, nombre, Semana);
    ...
    private void txtBuscarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyTyped
      ...
      public static javax.swing.JLabel lblcargojefe;
      public static javax.swing.JLabel lblnombrejefe;
